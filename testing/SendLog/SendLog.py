...
def event_stream(xcos_file_id):
	...
	print xcos_file_dir+xcos_file_name
	...
	_l = len(out)
	# Run xcos file
	command = ["./../../bin/scilab-adv-cli", "-nogui", "-e", "loadXcosLibs();importXcosDiagram('" + xcos_file_dir + xcos_file_name + "');xcos_simulate(scs_m,4);mode(2);xend();"];
